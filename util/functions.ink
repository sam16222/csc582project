...
=== function play_music()
    ...
    // most-negative block
        - cheating_confirmed and angry and n==1: #AUDIOLOOP: audio/1-5.mp3
        - cheating_confirmed and angry and n==2: #AUDIOLOOP: audio/2-5.mp3
        - cheating_confirmed and angry and n==3: #AUDIOLOOP: audio/3-5.mp3
        - cheating_confirmed and angry and n==4: #AUDIOLOOP: audio/4-5.mp3
        - cheating_confirmed and angry and n==5: #AUDIOLOOP: audio/5-5.mp3
        
    // somewhat negative block
        - (not cheating_confirmed or not angry) and (partner < 4) and n==1: #AUDIOLOOP: audio/1-4.mp3
        - (not cheating_confirmed or not angry) and (partner < 4) and n==2: #AUDIOLOOP: audio/2-4.mp3
        - (not cheating_confirmed or not angry) and (partner < 4) and n==3: #AUDIOLOOP: audio/3-4.mp3
